...
def test_app_client_create() -> None:
    ...
    assert ac.app_address is None, "Should not have app address"
...
def test_create(sb_accts: SandboxAccounts) -> None:
    ...
    assert ac.app_address == app_addr
    ...
    assert new_ac.app_address == app_addr
...
def test_update(sb_accts: SandboxAccounts) -> None:
    ...
    result_tx = client.pending_transaction_info(update_result.tx_ids[0])
    expect_dict(
        result_tx,
        {
            "pool-error": "",
...
def test_delete(sb_accts: SandboxAccounts) -> None:
    ...
    result_tx = client.pending_transaction_info(delete_result.tx_ids[0])
    expect_dict(
        result_tx,
        {
            "pool-error": "",
...
def test_opt_in(sb_accts: SandboxAccounts) -> None:
    ...
    result_tx = client.pending_transaction_info(opt_in_result.tx_ids[0])
    expect_dict(
        result_tx,
        {
            "pool-error": "",
...
def test_close_out(sb_accts: SandboxAccounts) -> None:
    ...
    result_tx = client.pending_transaction_info(close_out_result.tx_ids[0])
    expect_dict(
        result_tx,
        {
            "pool-error": "",
...
def test_clear_state(sb_accts: SandboxAccounts) -> None:
    ...
    result_tx = client.pending_transaction_info(clear_state_result.tx_ids[0])
    expect_dict(
        result_tx,
        {
            "pool-error": "",
...
def test_override_app_create(sb_accts: SandboxAccounts) -> None:
    ...
    txinfo = client.pending_transaction_info(create_result.tx_ids[0])
