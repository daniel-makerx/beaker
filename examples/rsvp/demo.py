...
def main() -> None:
    ...
    create_result = app_client.create(args={"event_price": 1 * consts.algo})
    ...
    def get_micro_algos() -> int | None:
        return cast(dict[str, Any], client.account_info(app_addr)).get("amount")
    ...
    app_client_guest1.opt_in(args={"payment": ptxn2})
    ...
    # Opt in to contract with event registration payment included
    app_client_guest2.opt_in(args={"payment": ptxn2})
